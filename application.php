...
<body>
    ...
    <center><font color="white" style="text-align:center;">This application can be used by a tourist to locate nearby place without getting lost or falling into the wrong hands.</font></center>
    <br/>
    ...
    <br/> -->
    <div class="container">
    	<h5>City Gude - Captrue Nearby Places</h5>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBycIZOQ-ClXJAVxmV0wDBYbXIF9Ao94og&callback=initAutocomplete&libraries=places&v=weekly&channel=2" async></script>
